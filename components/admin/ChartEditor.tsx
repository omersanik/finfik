...
import { Plus, Trash2, BarChart3, LineChart, PieChart, Palette, Settings } from 'lucide-react';
...
export default function ChartEditor({ value, onChange, placeholder }: ChartEditorProps) {
  ...
  }, [chartType, title, description, chartData, yAxisTitle, yAxisMin, yAxisMax, yAxisStepSize, initialized]);
          ...
          <div className="bg-gray-50 rounded-lg p-4 text-center">
            ...
            {chartType !== 'pie' && (
              <div className="mt-2 text-xs text-gray-500">
                Y-axis: {yAxisTitle} ({yAxisMin} - {yAxisMax}, step: {yAxisStepSize})
              </div>
            )}
            {/* Color preview */}
              ...
              {chartData.datasets.map((dataset, index) => (
                <div key={index} className="flex items-center gap-1">
                  <div 
                    ...
                    style={{ backgroundColor: dataset.backgroundColor || '#FF6384' }}
                  />
