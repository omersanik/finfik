    ...
    <TooltipProvider>
      <Card className="w-full max-w-md mx-auto shadow-lg border-orange-200 mt-0">
        <CardHeader className="flex flex-col items-center gap-2 pb-2 pt-2">
          <div className="flex items-center gap-3">
            ...
            <span
              className={`font-extrabold text-4xl text-orange-700 drop-shadow-md ${
        ...
        <CardContent className="flex flex-col items-center gap-2">
                  ...
                  <TooltipTrigger asChild>
                    <Badge
                      ...
                      className={`w-8 h-8 rounded-full flex items-center justify-center text-lg font-bold ${
                          ...
                          : "bg-background text-gray-400 border-gray-300"
                      }`}
                    >
                      {done ? (
          ...
          {/* Confetti burst */}
          {showConfetti && (
            <div className="absolute left-1/2 top-0 -translate-x-1/2 text-2xl pointer-events-none select-none animate-confetti">
              🎉✨🔥
            </div>
          )}
        </CardContent>
      ...
      <style jsx global>{`
        @keyframes flame-glow {
          ...
          50% {
            filter: drop-shadow(0 0 24px #fb923c);
          }
        }
        .animate-flame-glow {
          animation: flame-glow 1.2s infinite;
        }
        @keyframes bounce {
          0%,
          100% {
