        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <div className="absolute -top-3 -right-3">
                  <Badge variant="secondary" className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white border-0 shadow-lg">
            ...
            <p className="text-xl text-purple-700 max-w-3xl mx-auto leading-relaxed">
              Help us improve Finfik! As a beta user, your feedback is invaluable 
              in shaping the future of our platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="border-2 border-pink-200 bg-white/70 backdrop-blur-sm">
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-semibold text-pink-800 mb-2">Direct Impact</h3>
            ...
            <Card className="border-2 border-purple-200 bg-white/70 backdrop-blur-sm">
              <CardContent className="pt-6 text-center">
                ...
                <h3 className="font-semibold text-purple-800 mb-2">We Value You</h3>
                <p className="text-sm text-purple-600">
